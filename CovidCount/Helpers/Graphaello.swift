...
extension Covid {
    func countryDetailView(identifier: Covid.CountryIdentifier) -> some View {
        return QueryRenderer(client: client,
                             query: ApolloCovid.CountryDetailViewQuery(identifier: identifier)) { (data: ApolloCovid.CountryDetailViewQuery.Data) -> CountryDetailView in
...
public enum ApolloCovid {
    ...
    public final class CountryDetailViewQuery: GraphQLQuery {
        ...
        public var queryDocument: String { return operationDefinition.appending(StatsViewAffected.fragmentDefinition).appending(NewsStoryCellNewsStory.fragmentDefinition) }
    ...
    public struct StatsViewAffected: GraphQLFragment {
        ...
        public static let possibleTypes: [String] = ["DetailedContinent", "Country", "World", "__Affected", "__Continent", "__DetailedAffected"]
